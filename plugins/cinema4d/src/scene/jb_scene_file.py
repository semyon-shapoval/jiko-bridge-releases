...
class JbSceneFile(JbSceneInstance):
    ...
    def import_file(self, doc: c4d.documents.BaseDocument, file_path: str) -> bool:
        """Import file into document, returns success status."""
    ...
    def export_file(self, doc: c4d.documents.BaseDocument, ext: str) -> Optional[str]:
        """Export file from document, returns file path or None."""
    ...
    def _export_fbx(self, doc: c4d.documents.BaseDocument, file_path: str) -> Optional[str]:
    ...
    def _export_alembic(self, doc: c4d.documents.BaseDocument, file_path: str) -> Optional[str]:
    ...
    def _export_obj(self, _doc: c4d.documents.BaseDocument, _file_path: str) -> Optional[str]:
        return None

    def _export_usd(self, _doc: c4d.documents.BaseDocument, _file_path: str) -> Optional[str]:
        return None
