...
class JBFileExporter:
    ...
    def set_selection(
        ...
        """Sets the selection to the given objects."""
        doc.SetActiveObject(None, c4d.SELECTION_NEW)
        for obj in objects:
            obj.SetBit(c4d.BIT_ACTIVE)

    def _generate_path(self, ext: str) -> str:
        """Generates a unique file path in the cache directory with the given extension."""
    ...
    def export_file(
        ...
        """Exports the given objects to a file with the specified extension and returns the file path."""
    ...
    def export_fbx(
        ...
        self.set_selection(doc, objects)
